...
This was done on 2016-03-03 12:08:57.007642.
*/
...
port_INLINE void activity_ti1ORri1(OpenMote* self) {
 ...
 ieee154e_getAsn(self, sync_IE.asn);
               sync_IE.join_priority = ( neighbors_getMyDAGrank(self)/MINHOPRANKINCREASE)-1; //poipoi -- use dagrank(rank)-1
 ...
 radio_setTimerPeriod(self, (self->ieee154e_vars).slotDuration*(NUMSERIALRX));
...
port_INLINE void activity_ti9(OpenMote* self, PORT_RADIOTIMER_WIDTH capturedTime) {
 ...
 neighbors_isPreferredParent(self, &((self->ieee154e_vars).ackReceived->l2_nextORpreviousHop))
         ) {
...
// openserial_printInfo(self, COMPONENT_IEEE802154E,ERR_PACKET_SYNC,
