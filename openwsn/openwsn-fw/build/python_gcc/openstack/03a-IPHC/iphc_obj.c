...
This was done on 2016-03-03 12:09:54.080910.
*/
...
owerror_t iphc_sendFromForwarding(OpenMote* self, 
 ...
 packetfunctions_sameAddress(self, &(msg->l3_sourceAdd),(open_addr_t*)dagroot)
                ) || 
                (
                  ipv6_outer_header->src.type != ADDR_NONE &&
 packetfunctions_sameAddress(self, &(ipv6_outer_header->src),(open_addr_t*)dagroot)
                 )
            ){
                // hop limit
